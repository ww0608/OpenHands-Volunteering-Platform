...
namespace OpenHandsVolunteerPlatform.Areas.Identity.Pages.Account
{
    public class RegisterVolunteerModel  : PageModel
    {
        ...
        private readonly ILogger<RegisterVolunteerModel > _logger;
        private readonly IEmailSender _emailSender;

        //ROLE MANAGER; APPLICATIONDB ADDED:
        ...
        public RegisterVolunteerModel(
            ...
            ILogger<RegisterVolunteerModel> logger,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (Input.DateOfBirth.Date > today.AddYears(-age)) age--;
            if (age < 18 || age > 65)
            {
                ModelState.AddModelError("Input.DateOfBirth", "You must be between 18 and 65 years old.");
                return Page();
            }

            // Check for duplicate phone number
            var phoneExists = await _context.Volunteers
                .AnyAsync(v => v.Phone == Input.Phone);
